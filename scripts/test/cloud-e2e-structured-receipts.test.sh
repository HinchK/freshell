...
for invalid_records in \
  ...
  '[{"jsonPayload":{"event":"e2e_playwright_task_complete","execution":"wrong-execution","taskIndex":0,"taskCount":2,"recoveredRetryCount":0}},{"jsonPayload":{"event":"e2e_playwright_task_complete","execution":"wrong-execution","taskIndex":1,"taskCount":2,"recoveredRetryCount":0}}]' \
  '[{"jsonPayload":{"event":"e2e_playwright_task_complete","execution":"exec-probe","taskIndex":0,"taskCount":2,"recoveredRetryCount":1}},{"jsonPayload":{"event":"e2e_playwright_task_complete","execution":"exec-probe","taskIndex":1,"taskCount":2,"recoveredRetryCount":0}},{"jsonPayload":{"event":"e2e_playwright_retry_evidence","execution":"exec-probe","taskIndex":1,"taskCount":2,"failureAttempt":0,"trace":{"traceAttempt":0},"error":{"stack":"wrong task"}}}]' \
  '[{"jsonPayload":{"event":"e2e_playwright_task_complete","execution":"exec-probe","taskIndex":0,"taskCount":2,"recoveredRetryCount":1}},{"jsonPayload":{"event":"e2e_playwright_task_complete","execution":"exec-probe","taskIndex":1,"taskCount":2,"recoveredRetryCount":0}}]' \
  '[{"jsonPayload":{"event":"e2e_playwright_task_complete","execution":"exec-probe","taskIndex":0,"taskCount":2,"recoveredRetryCount":1}},{"jsonPayload":{"event":"e2e_playwright_task_complete","execution":"exec-probe","taskIndex":1,"taskCount":2,"recoveredRetryCount":0}},{"jsonPayload":{"event":"e2e_playwright_retry_evidence","execution":"exec-probe","taskIndex":0,"taskCount":2,"failureAttempt":0,"trace":{"traceAttempt":0},"error":{"stack":"first failure"}}},{"jsonPayload":{"event":"e2e_playwright_retry_evidence","execution":"exec-probe","taskIndex":0,"taskCount":2,"failureAttempt":1,"trace":{"traceAttempt":1},"error":{"stack":"duplicate"}}}]'; do
